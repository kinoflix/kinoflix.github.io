...
/* ==========================================================================
 3. USERNAME VƏ AD/SOYAD VALİDASİYASI
 ========================================================================== */
function isValidUsername(str) {
    if (!str) return false;
    // 3-10 simvol, yalnız A-Z a-z 0-9 . _
    // nöqtə başda və sonda ola bilməz, ard-arda nöqtə ola bilməz
...
function isValidName(str) {
    if (!str) return false;
    // Yalnız Unicode hərflər və boşluq, başda və sonda boşluq olmaz
...
/* ==========================================================================
 5. AUTENTİFİKASİYA - LOGIN / REGISTER / GOOGLE
 ========================================================================== */
...
document.getElementById('googleAuthBtn').addEventListener('click', async () => {
    try {
        ...
        if (!userDoc.exists()) {
            // Google ilə gələn istifadəçilər üçün username = email-in @-dən əvvəlki hissəsi
            const username = result.user.email.split('@')[0].replace(/[^A-Za-z0-9._]/g, '').slice(0, 10);
...
/* ==========================================================================
 9. İSTİFADƏÇİ SİYAHISI VƏ DROPDOWN MENYU
 ========================================================================== */
...
function renderUsersList() {
    ...
    allSorted.forEach(user => {
        ...
        // Şəbəkə banı (yalnız super_admin)
        if (myLevel === 4) {
            // Bu funksiya ayrıca hissədə işlənəcək, sadəcə düyməni əlavə edirik
    ...
    // Dropdown menyu hadisələrini əlavə et
    ...
    // Kənara kliklədikdə dropdownları bağla
...
function openPrivateRoom(targetUser) {
    ...
    privateRoomTitle.innerText = displayName;
...
profileSettingsForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const fsUpdate = { firstName: newFirstName, lastName: newLastName, displayName, photoURL: newAvatarUrl };
...
// Şəbəkə banı (IP+Cihaz) — yalnız super_admin
...
/* ==========================================================================
 19. GHOST HESAB TƏMİZLƏMƏ (Heartbeat sistemi)
 ========================================================================== */
(function () {
